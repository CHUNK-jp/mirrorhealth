    ...
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-white">Local AI Analysis</h2>
      ...
      {!ollamaRunning && (
        <div className="flex items-start gap-2 bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 text-sm text-yellow-300">
          ...
          <div>
            <p className="font-medium">Ollama not found</p>
            <p className="text-yellow-400/70 text-xs mt-1">
              Run <code className="bg-gray-900 px-1 rounded">ollama serve</code> in your terminal and try again.
              If no model is installed: <code className="bg-gray-900 px-1 rounded">ollama pull llama3.2</code>
            </p>
          </div>
        </div>
      )}
      ...
      <p className="text-xs text-gray-600 text-center">
        🔒 All data is processed only on your device. Nothing is sent to external servers.
      </p>
    </div>
  );
}
